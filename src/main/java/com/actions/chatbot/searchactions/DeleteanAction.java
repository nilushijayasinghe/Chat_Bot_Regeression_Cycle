...
public class DeleteanAction {
    ...
    @Test(alwaysRun = true)
    public void DeleteanAction()throws Exception{
        ...
        driver.findElement(By.xpath("//input[@id='j_idt34:txtName']")).sendKeys("Waters Edge");

        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

        driver.findElement(By.xpath("//textarea[@id='txtPattern']")).sendKeys("Waters Edge is a gated community within NorthLake Park, offering the rare opportunity for waterfront living.");
        ...
        WebElement elementLocator = driver.findElement(By.xpath("//*[contains(text(),'Waters Edge')]"));
        actions.contextClick(elementLocator).perform();
        WebElement elementOpen;
        driver.findElement(By.id("j_idt67")).click();

        driver.findElement(By.xpath("//button[@id='j_idt69']//span[@class='ui-button-text ui-c'][contains(text(),'Yes')]")).click();
