...
public class VerifyViewAction {
    ...
    @Test(alwaysRun = true)
    public void verifyViewAction()throws Exception{
        ...
        driver.findElement(By.xpath("//input[@id='j_idt34:txtName']")).sendKeys("Boxi Park");
        ...
        WebElement btnElement = driver.findElement(By.xpath("//*[contains(text(),'Boxi Park')]"));
        actions1.contextClick(btnElement).perform();
        WebElement elementOpennew =driver.findElement(By.xpath("//div[@id='j_idt64']//li[1]//a[1]"));
